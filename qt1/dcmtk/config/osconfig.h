...
#define DCMTK_BUILD_SINGLE_SHARED_LIBRARY ON
...
#define CANONICAL_HOST_TYPE "AMD64-Windows"
...
#define DCMTK_PREFIX "C:\\Program Files (x86)\\DCMTK"

/* Define the default data dictionary path for the dcmdata library package */
#define DCM_DICT_DEFAULT_PATH "C:\\Program Files (x86)\\DCMTK\\share\\dcmtk\\dicom.dic;C:\\Program Files (x86)\\DCMTK\\share\\dcmtk\\private.dic"
